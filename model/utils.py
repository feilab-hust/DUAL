...
def flip_denoise(x, predenoiser, noise_levels, flips=None, condition_x = None):
    b, c, w, h = x.shape
    ...
    x_recon = predenoiser(torch.cat(supports, dim=0), noise_levels)
...
def flip_denoise_noise(x, predenoiser, noise_levels, flips=[(False, False)]):
    b, c, w, h = x.shape
    #flips = [(False, False), (True, False), (False, True), (True, True)]
    supports = []
